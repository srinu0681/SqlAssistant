...
public class ExcelExportPlugin
{
    ...
    public ExcelExportPlugin(ITurnContext<IMessageActivity> turnContext, ConversationData conversationData, ExcelBuilder excelBuilder)
    {
    ...
    [KernelFunction, Description("Run SQL against the AdventureWorksLT database. Use the query in chat history if it is available. Use this function only if the final goal is to export the database results to excel.")]
    ...
    [KernelFunction, Description("Run SQL against the AdventureWorksLT database and export the datasbe results to excel. Use the query in chat history if it is available. Use this function only if the final goal is to send email.")]
